...
if(preg_match('/saddles?\.russfawson\.com/',$_SERVER['HTTP_HOST'])){
	...
	<!--<p><a href="http://www.russfawson.com/saddles/prices.php">Saddle Prices</a></p>-->
	<p><a href="http://www.russfawson.com/accessories/">Saddle Accesories</a></p>
	<p><a href="http://www.russfawson.com/contact/">Contact Russ Fawson</a></p>
	</div>
<?php
}else{
	?>
