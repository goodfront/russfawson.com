...
<title>Russ Fawson - Accessory Prices</title>
<!-- InstanceEndEditable -->
...
-->
</style><!-- InstanceEndEditable --><!-- InstanceParam name="SideNav" type="boolean" value="true" -->
</head>
...
<div class="z_mainFrame">
	...
	<!-- InstanceBeginEditable name="MainContent" -->
		<h1>Accessory Prices</h1>
		<p align="center">Prices are approximate and will vary with design.
			<a href="/contact/">Contact us for a quote.</a></p>
		<div class="tableBG" style="width:500px;">
			<table width="100%" cellpadding="5" cellspacing="0">
				<col width="145" />
				<col width="75" span="4" />
				<tr height="13">
					<th height="13" align="left" nowrap="nowrap">Item</th>
          <th align="right" nowrap>Base Price<br><small>(tooling extra, call for pricing)</small></th>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Cavalry Style Saddlebags</td>
					<td align="right">$250 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Small Saddlebags</td>
					<td align="right">$200 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Pommel Bags</td>
				...
				<tr height="13">
					<td height="13" nowrap="nowrap">Breast Collar</td>
					<td align="right">$175 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Bridle</td>
					<td align="right">$125 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Bucking Rolls</td>
					<td align="right">$85 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Spur Straps</td>
					<td align="right">$75 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Spurs (hand made)</td>
					<td align="right">$275 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Tapaderos</td>
					<td align="right">$250 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Canteen-Leather Covered </td>
				...
				<tr height="13">
					<td height="13" nowrap="nowrap">Belt Stitched (no buckle)</td>
					<td align="right">$50 </td>
				</tr>
				<tr height="13">
					<td height="13" nowrap="nowrap">Chinks (cow hide)</td>
				...
				<tr height="13">
					<td height="13" colspan="5" align="center" nowrap="nowrap"><p>Exotic Leathers Extra</p></td>
				</tr>
			</table>
		</div><p>&nbsp;</p>
	<!-- InstanceEndEditable -->
