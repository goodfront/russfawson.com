...
<title>Russ Fawson - Saddles</title>
<!-- InstanceEndEditable -->
...
<div class="z_mainFrame">
	...
	<!-- InstanceBeginEditable name="MainContent" -->
		<h1>Saddles</h1>
		<p>Russ uses only materials of the highest quality and can build saddles to suit both the working cowboy and the horse enthusiast.</p>
		<table cellpadding="0" cellspacing="0" class="a_tableMenu">
			<tr>
				<td class="a_menuTD" scope="col"><a href="index.php" class="a_menu1"><img src="/_elements/images/icons/photo.png" width="60" height="60" align="left" />Photos</a><br />
					<a href="index.php" class="a_menu3">See some of the saddles by Russ</a></td>
			</tr>
			<tr>
				<td class="a_menuTD"><a href="options.php" class="a_menu1"><img src="/_elements/images/icons/saddle.png" width="60" height="60" align="left" />Options</a><br />
					<a href="options.php" class="a_menu3">Explore some of the possibilities there are for your next saddle</a></td>
			</tr>
			<tr>
				<td class="a_menuTD"><a href="prices.php" class="a_menu1"><img src="/_elements/images/icons/coins.png" width="60" height="60" align="left" />Prices</a><br />
					<a href="prices.php" class="a_menu3">Price breakdown for Russ's custom made saddles</a></td>
			</tr>
		</table>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
